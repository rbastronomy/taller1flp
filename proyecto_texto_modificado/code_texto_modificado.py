from DataBase.conexion_texto_modificado import DAO
import funciones
dao = DAO()
idpatient = 0
def menu():
...
def submenunadm():
    ...
    while(flag==True):
        ...
        while(not flag2):
            ...
            print("5.- Ingresar un Paciente al sitema")
            print("6.- Actualizar un Paciente")
            print("7.- Eliminar un Paciente")
            print("8.- Ingresar Diagnostico")    
            print("9.- Buscar Paciente")  
            print("10.- Mostrar Tests")
